...
class TempetatureScreen extends StatefulWidget {
  ...
  @override
  State<TempetatureScreen> createState() => _TempetatureScreenState();
}

class _TempetatureScreenState extends State<TempetatureScreen> {
  //--------------------User input------------------------------------------------
...
//--------------Getting values ​​from local api-----------------------------------
  var items = TempetatureApi().getdata();
//------------------------------------------------------------------------------
  @override
                ...
                child: Column(
                    ...
                    children: [
                            ...
                            child: Center(
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: BlocBuilder<TempetatureBloc,
                                      ITempetatureState>(
                      ...
                      Row(
                        children: [
                          Expanded(child:
                              BlocBuilder<TempetatureBloc, ITempetatureState>(
                                  builder: (context, state) {
                            return Row(
                              children: [
                                Expanded(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: GestureDetector(
                                onTap: () {
                                  if (number == 0) {
                                    BlocProvider.of<TempetatureBloc>(context)
